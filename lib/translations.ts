const id = {
  ...
  "home.stacks.title": "Native BTC rail",
  "home.stacks.desc": "Tukar USDCx ke sBTC lewat Bitflow, pinjam USDCx di Zest.",
  "home.stacks.btn": "Buka",
  "home.stacks.connect": "Hubungkan",
  "home.tile.usdcx": "USDCx",
  "home.tile.stx": "STX",
  "home.balance.sbtc": "Total sBTC",
  "tx.usdcxToSbtc": "USDCx → sBTC",
  "tx.stacksDca": "DCA USDCx → sBTC",
  "tx.zestLock": "Kunci sBTC (Zest)",
  "tx.zestBorrow": "Pinjam USDCx (Zest)",
  "tx.zestRepay": "Bayar USDCx (Zest)",
  "tx.zestWithdraw": "Tarik sBTC (Zest)",
  "tx.stacksPending": "Menunggu konfirmasi",
  "tx.stacksSuccess": "Berhasil",
...
const en: Record<keyof typeof id, string> = {
  ...
  "home.stacks.title": "Native BTC rail",
  "home.stacks.desc": "Swap USDCx into sBTC via Bitflow, borrow USDCx on Zest.",
  "home.stacks.btn": "Open",
  "home.stacks.connect": "Connect",
  "home.tile.usdcx": "USDCx",
  "home.tile.stx": "STX",
  "home.balance.sbtc": "Total sBTC",
  "tx.usdcxToSbtc": "USDCx → sBTC",
  "tx.stacksDca": "USDCx → sBTC DCA",
  "tx.zestLock": "Lock sBTC (Zest)",
  "tx.zestBorrow": "Borrow USDCx (Zest)",
  "tx.zestRepay": "Repay USDCx (Zest)",
  "tx.zestWithdraw": "Withdraw sBTC (Zest)",
  "tx.stacksPending": "Pending",
  "tx.stacksSuccess": "Confirmed",
